...
This project contains data acquisition, preprocessing, normalization, batch correction, visualization, and organization code for GTEx dataset. It provides a comprehensive workflow for analyzing gene expression data from various tissues, facilitating downstream analysis and interpretation. This workflow implements a robust and accurate preprocessing pipeline for analyzing gene expression data of GTEx effectively correcting for batch effects while retaining biological variations associated with sex (view the 3D interactive PCA plot below) across 44 GTEx tissues. The process from data acquisition until batch correction is automated using Nextflow.
