...
This project contains data acquisition, preprocessing, normalization, batch correction, visualization, and organization code for GTEx dataset. It provides a comprehensive pipeline for analyzing gene expression data from various tissues, facilitating downstream analysis and interpretation. This code implements a robust pipeline for analyzing gene expression data of GTEx effectively correcting for batch effects while retaining biological variations associated with sex (view the 3D PCA plot below). The code isn't fully automated and requires manual inputs at specific points. Future updates will be focused on automating the code with less manual inputs
...
[View 3D UMAP plot](https://dhana2403.github.io/3D_PCA_plot/umap_plot_all_tissues_sva_3D.html)
[View 3D TNSE plot](https://dhana2403.github.io/3D_PCA_plot/tsne_plot_all_tissues_sva_3D.html)
