...
tmm_data_path <- "./data/processed/expression/readcounts_tmm_all_cross"
sva_data_path <- "./data/processed/expression/adjusted_sva_all_cross"
...
bar_plot <- ggplot(average_distances, aes(x = Tissue1, y = avg_distance, fill = Dataset)) +
  ...
  scale_fill_manual(values = c("darkgreen", "blue")) +  # Custom colors
